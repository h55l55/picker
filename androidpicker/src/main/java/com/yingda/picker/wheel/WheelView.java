...
package com.yingda.picker.wheel;
...
import com.yingda.picker.wheel.adapters.WheelViewAdapter;
...
//        int desired = layout.getMeasuredHeight();
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.c4_4));
        // 设置线宽
